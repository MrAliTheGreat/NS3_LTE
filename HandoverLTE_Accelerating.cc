...
NotifyConnectionEstablishedUe (std::string context,
                               ...
                               uint16_t rnti)
{
  std::cout << "..... Ue: CONNECTION-ESTABLISHED!!!\n";
  std::cout << context
            << " UE IMSI " << imsi
...
NotifyHandoverEndOkUe (std::string context,
                       ...
                       uint16_t rnti)
{
  std::cout << "..... Ue: HANDOVER-SUCCESSFUL-END!!!\n";  
  std::cout << context
            << " UE IMSI " << imsi
...
NotifyConnectionEstablishedEnb (std::string context,
                                ...
                                uint16_t rnti)
{
  std::cout << "..... Enb: CONNECTION-ESTABLISHED!!!\n";  
  std::cout << context
            << " eNB CellId " << cellid
...
NotifyHandoverEndOkEnb (std::string context,
                        ...
                        uint16_t rnti)
{
  std::cout << "..... Enb: HANDOVER-SUCCESSFUL-END!!!\n";    
  std::cout << context
            << " eNB CellId " << cellid
...
main (int argc, char *argv[])
{
  ...
  double simTime = (double)(numberOfEnbs + 2) * distance / speed; // 1500 m / 20 m/s = 75 secs
  ...
  for (uint16_t i = 0 ; i < numberOfUes; i++){
    ueNodes.Get (i)->GetObject<MobilityModel> ()->SetPosition (Vector (((rand() % 200) - 200), yForUe + (rand() % 100), 0));
    ueNodes.Get (i)->GetObject<ConstantAccelerationMobilityModel> ()->SetVelocityAndAcceleration (Vector (speed + (rand() % 30), 0, 0) , 
                                                                                          Vector (acceleration + (rand() % 5) , 0 , 0) );
  }
  ...
  AnimationInterface anim ("HandoverLTE_Acceleration_XML_File.xml");
