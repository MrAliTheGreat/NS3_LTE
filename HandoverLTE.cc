...
main (int argc, char *argv[])
{
  ...
  double speed = 20;       // m/s
  double simTime = (double)(numberOfEnbs + 2) * distance / speed;
  ...
  for (uint16_t i = 0 ; i < numberOfUes; i++){
    ...
    ueNodes.Get (i)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (speed + (rand() % 30), 0, 0));
  }
  ...
  AnimationInterface anim ("HandoverLTE_XML_File.xml");
